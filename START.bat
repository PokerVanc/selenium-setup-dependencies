...
"C:\Program Files (x86)\Java\jre1.8.0_333\bin\java.exe" -jar selenium-server-4.2.2.jar standalone --override-max-sessions true --max-sessions 20 --session-timeout 1800 --allow-cors true
