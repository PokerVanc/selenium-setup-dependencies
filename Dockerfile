...
RUN git clone --branch v4-linux-firefox https://github.com/iliaamiri/selenium-setup-dependencies.git

WORKDIR /root/setup/selenium-setup-dependencies
...
CMD ["/bin/bash", "/root/setup/selenium-setup-dependencies/START.sh"]